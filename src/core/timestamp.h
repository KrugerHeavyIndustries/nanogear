...
namespace nanogear
{
   ...
   {
   public:
      typedef uint64_t TimeVal;    /// monotonic UTC time value in microsecond resolution
      typedef uint64_t UtcTimeVal; /// monotonic UTC time value in 100 nanosecond resolution
      typedef uint64_t TimeDiff;   /// difference between two timestamps in microseconds
