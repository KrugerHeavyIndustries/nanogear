...
//  nanogear
//
//  Created by Chris Kruger on 19/02/2015.
//
//

#ifndef __nanogear__datetimeformatter__
#define __nanogear__datetimeformatter__
...
#endif /* defined(__nanogear__datetimeformatter__) */
