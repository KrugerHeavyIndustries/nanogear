...
public:
    ...
    ClientInfo(const PreferenceList<MimeType>& mimeTypes,
                const PreferenceList<Locale>& locales,
                const PreferenceList<TextCodec*>& codecs,
     ...
     * \return The list of accepted MIME types
     */
    const PreferenceList<Locale>& acceptedLocales() const
    { return m_locales; }

    /*!
     * \return The list of accepted charsets
     */
    const PreferenceList<TextCodec*>& acceptedTextCodecs() const
    { return m_codecs; }

private:
    PreferenceList<MimeType> m_mimeTypes;
    PreferenceList<Locale> m_locales;
    PreferenceList<TextCodec*> m_codecs;
    string m_userAgent;
};
