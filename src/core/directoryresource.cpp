...
DirectoryResource::DirectoryResource(const string& root)
:  m_root(root),
   m_indexAllowed(true)
{
...
void DirectoryResource::handleGet(const Request& request, Response& response)
{
...
void DirectoryResource::representFile(const File& file, Response& response)
{
...
std::string DirectoryResource::xhtmlRepresentation(const std::string &title, const std::string& table)
{
