...
public:
     ...
     */
    Request(const Method& method, const ClientInfo& clientInfo, Representation* body) :
     ...
     */
    const Representation* entity() const
     ...
     */
    void setEntity(Representation* representation)
