...
#ifndef CONNECTORS_IHTTP_HTTPSERVER_H
#define CONNECTORS_IHTTP_HTTPSERVER_H 1
 ...
 */
class HTTPServer : public QTcpServer, public Server
{
    Q_OBJECT
public:
    /*!
...
#endif /* CONNECTORS_IHTTP_HTTPSERVER_H */
